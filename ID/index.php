...
<div class="collapse" id="collapseExample">
      ...
      <tbody>
        <?php 
          ...
          while($row = mysqli_fetch_assoc($result)){
            ...
            <td>". $row['name'] . "</td>
            <td>". $row['id_no'] . "</td>
            <td> <button class='edit btn btn-sm btn-primary' id=".$row['sno'].">Edit</button> <button class='delete btn btn-sm btn-primary' id=d".$row['sno'].">Delete</button> <a class = \"btn btn-outline-success\" href=\"id-card.php?id=$row[sno]\">view</a></td>
          </tr>";
        } 
          ?>
  ...
  <hr>
  <a href="" type="button" class="btn btn-primary btn-lg btn-block" target="_blank"></a>
  <!-- Optional JavaScript -->
